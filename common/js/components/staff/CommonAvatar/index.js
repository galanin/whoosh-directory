...
class CommonAvatar extends React.Component {
  render() {
    const avatar = AVATARS[this.props.gender] != null ? AVATARS[this.props.gender][this.props.post_code] : undefined;

    if (avatar != null) {
      return div({ className: 'common-avatar ' + this.props.className },
        svg({ svg: avatar }));
    } else {
      return '';
    }
