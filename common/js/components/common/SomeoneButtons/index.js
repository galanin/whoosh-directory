...
class SomeoneButtons extends React.Component {
  ...
  render() {
    ...
    return div({ className: classNames(class_names) },
      div({ className: 'employee-buttons__button employee-buttons__to-call', onClick: this.onAddToCall.bind(this) },
      ...
      div({ className: 'employee-buttons__button employee-buttons__favorite', onClick: this.onFavorite.bind(this) },
