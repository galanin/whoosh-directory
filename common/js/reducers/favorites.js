...
export default (function(state, action) {
  ...
  switch (action.type) {
    case LOADED_FAVORITE_PEOPLE:
      ...
      forEach(action.favorite_people, function(people) {
        if (people.employment_id != null) {
          return new_employment_index[people.employment_id] = true;
        } else if (people.contact_id != null) {
    ...
    case LOADED_FAVORITE_UNITS:
      ...
      forEach(action.favorite_units, unit => new_unit_index[unit.unit_id] = true);
