...
export default (state, action) => {
  ...
  switch (action.type) {
    case LOADED_TO_CALL:
      ...
      for (to_call of action.data) {
        new_data[to_call.id] = to_call;
      }

      for (unchecked_to_call_id of action.unchecked) {
        unchecked_to_call = new_data[unchecked_to_call_id];
        if (unchecked_to_call.employment_id) {
          new_unchecked_employment_index[unchecked_to_call.employment_id] = 1;
        }
        if (unchecked_to_call.contact_id) {
          new_unchecked_contact_index[unchecked_to_call.contact_id] = 1;
        }
      }
    ...
    case ADDING_EMPLOYMENT_TO_CALL:
      new_unchecked_employment_index = Object.assign(
        {},
        state.unchecked_employment_index
      );
    ...
    case ADDING_CONTACT_TO_CALL:
      new_unchecked_contact_index = Object.assign(
        {},
        state.unchecked_contact_index
      );
    ...
    case CHANGED_TO_CALL:
      ...
      for (to_call_id of action.unchecked) {
